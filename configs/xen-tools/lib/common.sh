...
#
#  Update Debian packages via apt-get.
#
#  We take special care so that daemons shouldn't start after installation
# which they might otherwise do.
#
...
updateDebianPackages ()
{
    ...
    # Log our options
    #
    logMessage "Updating Debian packages to prefix ${prefix}"
    ...
    # Install the packages
    #
    DEBIAN_FRONTEND=noninteractive chroot ${prefix} /usr/bin/apt-get --yes --force-yes update

}


#
#  Upgrade Debian packages via apt-get.
#
#  We take special care so that daemons shouldn't start after installation
# which they might otherwise do.
#
...
upgradeDebianPackages ()
{
    ...
    # Log our options
    #
    logMessage "Upgrading Debian packages to prefix ${prefix}"
    ...
    # Install the packages
    #
    DEBIAN_FRONTEND=noninteractive chroot ${prefix} /usr/bin/apt-get --yes --force-yes upgrade
